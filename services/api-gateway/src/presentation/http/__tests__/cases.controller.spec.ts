...
describe("CasesController", () => {
  ...
  beforeEach(async () => {
    mockCasesService = {
      ...
      createInterventionType: jest.fn(),
      listInterventionTypes: jest.fn(),
      getInterventionType: jest.fn(),
      updateInterventionType: jest.fn(),
      deleteInterventionType: jest.fn(),
      createCase: jest.fn(),
      listCases: jest.fn(),
      listCaseIdsForParty: jest.fn(),
      getCase: jest.fn(),
      updateCase: jest.fn(),
      deleteCase: jest.fn(),
      updateTodo: jest.fn(),
      ...
      setInterventionBillingStatus: jest.fn(),
