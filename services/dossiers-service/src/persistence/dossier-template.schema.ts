...
export class DossierTemplateDocument extends Document {
...
export const DossierTemplateSchema =
  SchemaFactory.createForClass(DossierTemplateDocument);
DossierTemplateSchema.index({ organizationId: 1, name: 1 }, { unique: true });
