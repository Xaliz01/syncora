...
| Facturation             | `/billing`                         | `billing.invoices.read` (ou `exports.billing`) |
...
| Nouvel article          | `/settings/stock/articles/new`     | `stock.articles.create`                        |
| Prestations             | `/settings/prestations`            | `prestations.read`                             |
| Nouvelle prestation     | `/settings/prestations/new`        | `prestations.create`                           |
| Emplacements de stock   | `/settings/stock/locations`        | `stock.locations.read`                         |
| Nouvel emplacement      | `/settings/stock/locations/new`    | `stock.locations.create`                       |
...
| Nouveau type d’interv.  | `/settings/intervention-types/new` | `intervention_types.create`                    |
