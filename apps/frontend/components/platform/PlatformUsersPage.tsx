  ...
  return (
    <div className="space-y-4">
      ...
      <FormDialog
        open={!!emailTarget}
        onClose={closeEmail}
        closeDisabled={emailSending || emailPreviewing}
        title={`E-mail à ${emailTarget?.name || emailTarget?.email || ""}`}
        description={emailTarget?.email}
        titleId="platform-email-title"
        size="lg"
        zClassName="z-50"
        ...
        footer={
          <>
            ...
            <FormDialogCancelButton
              ...
              disabled={
                emailSending || emailPreviewing || emailSubject.trim().length < 3 || !emailTarget
              }
            >
            ...
            <FormDialogPrimaryButton
              type="submit"
              disabled={emailSending || emailPreviewing || !emailTarget}
            >
