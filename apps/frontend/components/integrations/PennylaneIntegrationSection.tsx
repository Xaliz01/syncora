...
export function PennylaneIntegrationSection() {
  ...
  const confirmReplaceOther = async () => {
    ...
    return confirm({
      title: `Remplacer ${other} par Pennylane ?`,
      description: `Une seule intégration de facturation est active à la fois. ${
        other === "Qonto" ? "La connexion Qonto" : "La facturation démo"
      } sera déconnectée.`,
      ...
      <div className="flex gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
            Connectez votre compte Pennylane pour créer et suivre une facture depuis un dossier,
            sans ressaisir client ni lignes.
          </p>
        </div>
      </div>
