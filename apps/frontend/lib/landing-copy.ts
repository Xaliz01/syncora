...
export const LANDING_HERO_SUPPORT =
  "Solo, duo ou petite équipe : centralisez clients, dossiers, interventions, contrats de maintenance et facturation — sans complexité enterprise, à un prix clair dès le départ.";
